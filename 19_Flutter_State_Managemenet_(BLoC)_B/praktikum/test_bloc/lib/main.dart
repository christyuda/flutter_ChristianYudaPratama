...
import 'package:test_bloc/galeri.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _addContact() {
    ...
    if (editingIndex == -1) {
      _contactBloc.add(AddContactEvent(newContact));
    } else {
      _contactBloc.add(EditContactEvent(editingIndex, newContact));
      editingIndex = -1;
    }
  ...
  Widget build(BuildContext context) {
    final ContactBloc _contactBloc =
        BlocProvider.of<ContactBloc>(context); // Ambil Bloc dari context
